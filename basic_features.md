		...
		<div id="main_content" class="contained span8">
			...
			<div id="guided_tour" style="font-family:verdana;">
				...
				<div id="guided_tour_content">
					...
					<p> [NOTE: The Guided Tour is based upon Java OceanAtlas 5.5. Some features are slightly different in other JOA versions, but the basic functions are the same.]</p>
