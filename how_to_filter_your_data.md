		...
		<div id="main_content" class="contained span8">
			...
			<div id="guided_tour" style="font-family:verdana;">
				...
				<div id="guided_tour_content">
					...
					<p> Clicking the 'OK' closes the dialog and applies the selected conditions to the data, 'Remove' cancels the current station filter, 'Apply' applies the selected conditions to the data but does not close the dialog, and 'Close' closes the dialog box without performing any actions. </p> <img alt="fig-20" class="gt_image" src="assets/images/fig20.png">
